...
export const UserAuth: React.FC = () => {
  ...
  return (
    <button 
      ...
      className="flex items-center justify-center gap-3 w-full p-4 rounded-xl bg-white text-slate-800 font-bold border border-gray-300 hover:bg-gray-50 transition-all shadow-sm"
    >
